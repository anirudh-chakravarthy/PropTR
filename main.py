...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--pretrained_weights', type=str, default="r50_pretrained.pth",
    ...
    parser.add_argument('--output_dir', default='r50_proptr',
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            # extra checkpoint before LR drop and every 1 epoch
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('PropTR training and evaluation script', parents=[get_args_parser()])
